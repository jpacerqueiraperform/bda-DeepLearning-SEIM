...
pwd
cd ..
sudo /opt/cloudera/parcels/Anaconda/bin/python3.6 /opt/cloudera/parcels/Anaconda/bin/pip install ./tabulate-0.8.2
#
#
...
pwd
cd ..
sudo /opt/cloudera/parcels/Anaconda/bin/python3.6 /opt/cloudera/parcels/Anaconda/bin/pip install ./future-0.16.0
#
#
#
...
pwd
cd ..
sudo /opt/cloudera/parcels/Anaconda/bin/python3.6 /opt/cloudera/parcels/Anaconda/bin/pip install ./h2o-3.22.0.1
#
