...
,CAST(urltopredict_files.url_kl_phish AS DOUBLE) AS url_kl_phish , CAST(urltopredict_files.url_bad_kl_phish AS INT) AS url_bad_kl_phish, CAST(urltopredict_files.url_ks_phish AS DOUBLE) AS url_ks_phish ,CAST(urltopredict_files.url_bad_ks_phish AS INT) AS url_bad_ks_phish \
