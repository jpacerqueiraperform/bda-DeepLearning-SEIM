...
CAST(urltopredict_files.url_ks_phish AS DOUBLE) AS url_ks_phish, CAST(urltopredict_files.url_bad_ks_phish AS INT) AS CAST(urltopredict_files.url_bad_ks_phish AS INT) AS url_bad_ks_phish FROM urltopredict_files"
