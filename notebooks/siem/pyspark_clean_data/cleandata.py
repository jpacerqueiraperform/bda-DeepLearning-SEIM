...
.withColumn('ynverified',func_url_verified_known_udf(url_df_validdf[verified_di]))\
.withColumn('url_length',func_url_lengh_udf(url_df_validdf['url']))\
.withColumn('massiveurl',func_url_big_udf(url_df_validdf['url']))\
.withColumn('count_at',func_url_count_at_udf(url_df_validdf['url']))\
.withColumn('count_dot',func_url_count_dot_udf(url_df_validdf['url']))\
.withColumn('url_is_ip',func_url_is_ip_udf(url_df_validdf['url']))\
.withColumn('count_dot_com',func_count_dot_com_udf(url_df_validdf['url']))\
.withColumn('url_kl_en',func_kl_en_url_udf(url_df_validdf['url']).cast('double'))\
.withColumn('url_bad_kl_en',func_bad_kl_en_url_udf(url_df_validdf['url']))\
.withColumn('url_ks_en',func_ks_en_url_udf(url_df_validdf['url']).cast('double'))\
.withColumn('url_bad_ks_en',func_bad_ks_en_url_udf(url_df_validdf['url']))\
.drop(*list_to_drop)
#
#
