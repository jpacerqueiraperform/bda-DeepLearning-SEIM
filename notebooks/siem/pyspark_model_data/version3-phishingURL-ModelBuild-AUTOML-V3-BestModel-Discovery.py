...
#
# Extract MODEL
aml.leader.download_mojo(path = "/home/siemanalyst/notebooks/siem/product_model_bin/m40/v3/mojo", get_genmodel_jar = True)
#
print("Model in folder /home/siemanalyst/notebooks/siem/product_model_bin/m40/v3/mojo")
#
sc.stop()
#
