...
sparkSession = (SparkSession
                .builder
                .appName('ImportData-TableAs-model4-SIEM')
                .enableHiveSupport()
                .getOrCreate())
...
sparkSession.sql("ADD JAR hdfs:////user/siemanalyst/predictor/udf/h2o-genmodel.jar")
sparkSession.sql("ADD JAR hdfs:///user/siemanalyst/predictor/udf/ScoreDataUDFAUTOML-4.0-SNAPSHOT.jar")
sparkSession.sql("CREATE TEMPORARY FUNCTION scoredataM4 AS 'ai.h2o.hive.udf.ScoreDataM4UDF' ")
