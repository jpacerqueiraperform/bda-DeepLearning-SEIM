...
wget -O  CC-MAIN-2018-43-index-.cn.json  https://index.commoncrawl.org/CC-MAIN-2018-43-index?url=*.cn&output=json
wget -O  CC-MAIN-2018-43-index-.cz.json  https://index.commoncrawl.org/CC-MAIN-2018-43-index?url=*.cz&output=json
wget -O  CC-MAIN-2018-43-index-.kp.json  https://index.commoncrawl.org/CC-MAIN-2018-43-index?url=*.kp&output=json
wget -O  CC-MAIN-2018-43-index-.us.json  https://index.commoncrawl.org/CC-MAIN-2018-43-index?url=*.us&output=json
