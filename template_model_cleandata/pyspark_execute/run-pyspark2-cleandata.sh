...
spark2-submit --master yarn --deploy-mode client $MY_FOLDER/cleandata-model3-func15.py
## Stage url_ml_score_predict
spark2-submit --master yarn --deploy-mode client --jars $MY_FOLDER/spark_jars/ScoreDataUDFAUTOML-3.0-SNAPSHOT.jar,$MY_FOLDER/spark_jars/h2o-genmodel.jar  $MY_FOLDER/import-to-urlpredictions-model3-func15.py
#
