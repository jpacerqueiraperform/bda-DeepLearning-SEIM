...
#
scp siemanalyst@chpbdaodi02.prod.ch.perform.local:~/notebooks/siem/product_model_bin/m20/mojo/StackedEnsemble_AllModels_AutoML_20181116_125005.zip .
cp StackedEnsemble_AllModels_AutoML_20181116_125005.zip ../src/main/resources/ai/h2o/hive/udf/
#
