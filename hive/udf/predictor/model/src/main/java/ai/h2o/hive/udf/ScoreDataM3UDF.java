...
@Description(name="scoredatav3", value="_FUNC_(*) - Returns a score for the given row",
...
public class ScoreDataM3UDF extends GenericUDF {
    ...
    public String getDisplayString(String[] args) {
        return "scoredatav3("+Arrays.asList(p.getNames())+").";
    }
    @Override
    ...
    public ObjectInspector initialize(ObjectInspector[] args) throws UDFArgumentException {
        ...
        URL mojoURL = ScoreDataM3UDF.class.getResource("GBM_4_AutoML_20181123_204136.zip");
        ...
        if (record != null) {
            if (record.length == p.getNumCols()) {
                ...
                throw new UDFArgumentException("Incorrect number of arguments." +
                        "  scoredatav3() requires: " + Arrays.asList(p.getNames()) + ", in order. Received "
